...
import { ButtonLink, TitleH2 } from "../components";
      ...
      <section className={styles.container}>
        ...
        <div className={styles.text}>
          <p className={styles.description}>
            Nasza firma zajmowała się na początku sprzedażą drzewa opałowego oraz wycinką drzew. Z czasem poszerzyliśmy nasze usługi o prace
            ogrodnicze oraz o alpinistyczną wycinkę drzew.
          </p>
          <p className={styles.description}>
